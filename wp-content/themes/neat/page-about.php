	...
	<div class="container-wrap">
		<aside id="fh5co-hero">
			<div class="flexslider">
				<?php $postSlideData = getDataAboutPageSlideById(385) ?>
				<ul class="slides">
		...
		<div id="fh5co-about">
			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1 text-center animate-box">
					<p><img src="<?php echo get_template_directory_uri(). '/images/cover_bg_3.jpg'?>" alt="Free HTML5 Bootstrap Template" class="img-responsive"></p>
				</div>
